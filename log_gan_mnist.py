...
# plt.savefig('log_gan_mnist/train_avg')
# plt.close()
...
#           print('gradients: ', gradients)
      ...
      # inverted_x = np.zeros((NUM_LABEL, x_dim))
      # for i in range(NUM_LABEL):
      #   print("i = %d" % i)
      #   inverted_x[i] = fred_mi(i, y_ml, sess, 1)[0]
      #   adv_img = plt.imshow(np.reshape(inverted_x[i], (28, 28)), cmap="gray", origin='lower')
      #   plt.savefig('log_gan_mnist/fred_mi_'+str(i))
      ...
      for i in range(120001):      
        ...
        if i % 4000 == 0:
          ...
          plot_gan_image('log_gan_mnist/gan_out',str(i), sess)
